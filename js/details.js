 ...
 for (let i = 0; i < data.length; i++){
  //   console.log(data[i].name);
    ...
    function paintDOM(data){
     ...
     const tagToUpDate = document.getElementById("deta");
        ...
        <div class="row g-0 ">
          ...
          <div class="col-md-8">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">${data[i].description}</li>
                <li class="list-group-item">📆 Date:${data[i].date}  </li>
                <li class="list-group-item">🕋 Place:${data[i].place} </li>
                <li class="list-group-item">🚻 Capacity:${data[i].capacity}</li>
                <li class="list-group-item">✔️Estimate:${data[i].estimate} </li>
                <li class="list-group-item">✔️Assistance:${data[i].assistance} </li>
                <li class="list-group-item">Price: $ USD ${data[i].price}</li>
              </ul>
